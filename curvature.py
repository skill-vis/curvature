...
# # Add arrow to show pitching direction
# arrow_length = (ax.get_xlim()[1] - ax.get_xlim()[0]) * 0.5  # 20% of x-axis length
# arrow_start = [(ax.get_xlim()[1] + ax.get_xlim()[0])/2, ax.get_ylim()[0], 0]  # Middle of x-axis, front of y-axis
# arrow_direction = [arrow_length, 0, 0]  # Point in positive x direction

# ax.quiver(arrow_start[0], arrow_start[1], arrow_start[2],
#           arrow_direction[0], arrow_direction[1], arrow_direction[2],
#           color='black', alpha=0.7)

# # Add "Pitching direction" text
# text_pos = [arrow_start[0] + arrow_length/2,  # X position: middle of arrow
#             arrow_start[1] - (ax.get_ylim()[1] - ax.get_ylim()[0])*0.05,  # Y position: slightly below arrow
#             0]  # Z position: at zero level
